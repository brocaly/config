...
# From config
cp -r ~/.config/scripts ~/.config/kitty ~/.config/mpd ~/.config/mpv ~/.config/ncmpcpp ~/.config/ranger ~/.config/sxhkd ~/Downloads/config/.config
...
cp -r ~/Downloads/packages/yay ~/Downloads/config/compile
